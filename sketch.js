...
function setup() {
	...
	bobObject1 = new Bob(420,400,20);
	bobObject2 = new Bob(460,400,20);
	bobObject3 = new Bob(500,400,20);
	bobObject4 = new Bob(540,400,20);
	bobObject5 = new Bob(560,400,20);
	roof = new Roof(500,100,80,5);
...
function keyPressed(){
	if(keyCode === UP_ARROW){
		Matter.Body.applyForce(bobObject1.body,bobObject1.body.position,{x:-100,y:300})
	}
}
